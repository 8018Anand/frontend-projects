document.addEventListener("DOMContentLoaded", function () {
  ...
  function displayUserData(parsedData) {
    ...
    function myFunction(data) {
      return `<div class="card"><h4>${data.label}</h4><p class="semiCol">:</p><p class="value">${data.value}</p></div>`;
    }
    cardStatsContainer.innerHTML = cardsData.map(myFunction).join("");
  }
...
//need to change the regular expression for username validation
